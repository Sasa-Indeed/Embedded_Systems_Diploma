...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm Task2_BlueLED_Alarm : AppSTD */ ,
  1 /* alarm Task3_OrangeLED_Alarm : AppSTD */ 
};
...
/* Alarm Task2_BlueLED_Alarm identifier */
#define Task2_BlueLED_Alarm_id 0
CONST(AlarmType, AUTOMATIC) Task2_BlueLED_Alarm = Task2_BlueLED_Alarm_id;

/* Alarm Task3_OrangeLED_Alarm identifier */
#define Task3_OrangeLED_Alarm_id 1
CONST(AlarmType, AUTOMATIC) Task3_OrangeLED_Alarm = Task3_OrangeLED_Alarm_id;
...
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Task2_stack_zone[3000/sizeof(tpl_stack_word)];
#define APP_Task_Task2_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Task2_STACK {Task2_stack_zone, 3000}
...
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Task3_stack_zone[3000/sizeof(tpl_stack_word)];
#define APP_Task_Task3_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Task3_STACK {Task3_stack_zone, 3000}
 ...
 */
/*-----------------------------------------------------------------------------
 * Alarm Task2_BlueLED_Alarm descriptor
 *
...
CONST(tpl_task_activation_action, OS_CONST) Task2_BlueLED_Alarm_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) Task2_BlueLED_Alarm_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , Task2_BlueLED_Alarm_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&Task2_BlueLED_Alarm_action
};
...
VAR(tpl_time_obj, OS_VAR) Task2_BlueLED_Alarm_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&Task2_BlueLED_Alarm_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  100,
    /* date                         */  300,
...
/*-----------------------------------------------------------------------------
 * Alarm Task3_OrangeLED_Alarm descriptor
 *
...
CONST(tpl_task_activation_action, OS_CONST) Task3_OrangeLED_Alarm_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  Task3_id
...
CONST(tpl_alarm_static, OS_CONST) Task3_OrangeLED_Alarm_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , Task3_OrangeLED_Alarm_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&Task3_OrangeLED_Alarm_action
};
...
VAR(tpl_time_obj, OS_VAR) Task3_OrangeLED_Alarm_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&Task3_OrangeLED_Alarm_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  200,
    /* date                         */  450,
...
CONSTP2VAR(tpl_time_obj, AUTOMATIC, OS_APPL_DATA)
  ...
  &Task2_BlueLED_Alarm_alarm_desc,
  &Task3_OrangeLED_Alarm_alarm_desc
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
