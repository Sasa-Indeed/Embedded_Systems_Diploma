...
/*=============================================================================
 * To disable the priority 5 interrupts, the corresponding ICER
 * are set
 */
FUNC(void, OS_CODE) tpl_disable_priority_5_interrupts(void)
{
  NVIC->ICER[0] = 0x40;
}

/*=============================================================================
 * To enable the priority 5 interrupts, the corresponding ISER
 * are set
 */
FUNC(void, OS_CODE) tpl_enable_priority_5_interrupts(void)
{
  NVIC->ISER[0] = 0x40;
}
...
CONST(tpl_enable_disable_func, OS_CONST) tpl_enable_table[1] = {
  tpl_enable_priority_5_interrupts
};

CONST(tpl_enable_disable_func, OS_CONST) tpl_disable_table[1] = {
  tpl_disable_priority_5_interrupts
};
