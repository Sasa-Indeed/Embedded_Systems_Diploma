...
/* Alarm Task1_Alarm identifier */
#define Task1_Alarm_id 0
CONST(AlarmType, AUTOMATIC) Task1_Alarm = Task1_Alarm_id;
...
CONST(tpl_task_activation_action, OS_CONST) Task1_Alarm_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) Task1_Alarm_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , Task1_Alarm_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&Task1_Alarm_action
};
...
VAR(tpl_time_obj, OS_VAR) Task1_Alarm_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&Task1_Alarm_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  30,
    /* date                         */  30,
