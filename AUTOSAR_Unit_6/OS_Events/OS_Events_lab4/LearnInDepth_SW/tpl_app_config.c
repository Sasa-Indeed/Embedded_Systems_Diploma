...
/* Event Task2_Event1 */
#define Task2_Event1_mask 1
CONST(EventMaskType, AUTOMATIC) Task2_Event1 = Task2_Event1_mask;

/* Event Task2_Event2 */
#define Task2_Event2_mask 2
CONST(EventMaskType, AUTOMATIC) Task2_Event2 = Task2_Event2_mask;
...
/* Alarm Task2_Alarm identifier */
#define Task2_Alarm_id 0
CONST(AlarmType, AUTOMATIC) Task2_Alarm = Task2_Alarm_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Alarm Task2_Alarm descriptor
 *
 * This alarm does a set of event Task2_Event2 to task Task2
 */
...
CONST(tpl_setevent_action, OS_CONST) Task2_Alarm_action = {
  {
    /* action function  */    tpl_action_setevent
  },
  /* task id              */  Task2_id,
  /* event mask           */  Task2_Event2_mask
};
...
CONST(tpl_alarm_static, OS_CONST) Task2_Alarm_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , Task2_Alarm_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&Task2_Alarm_action
};
...
VAR(tpl_time_obj, OS_VAR) Task2_Alarm_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&Task2_Alarm_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  30,
    /* date                         */  30,
